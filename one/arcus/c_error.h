...
typedef enum OneError {
    ...
    ONE_ERROR_EMPTY,
    ONE_ERROR_INSUFFICIENT_SPACE,
    ONE_ERROR_MESSAGE_ALLOCATION_FAILED,
    ONE_ERROR_MESSAGE_CALLBACK_IS_NULLPTR,
    ONE_ERROR_MESSAGE_IS_NULLPTR,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_ALLOCATED_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_ERROR_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_HOST_INFORMATION_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_LIVE_STATE_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_LIVE_STATE_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_META_DATA_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_MATCHING_EXPECTING_SOFT_STOP_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_IS_NOT_SUPPORTED,
    ONE_ERROR_MESSAGE_OPCODE_PAYLOAD_IS_NOT_EMPTY,
    ONE_ERROR_OBJECT_KEY_IS_NOT_FOUND,
    ...
    ONE_ERROR_PAYLOAD_KEY_IS_NOT_FOUND,
