...
typedef enum OneError {
    ...
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_ALLOCATED_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_LIVE_STATE_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_LIVE_STATE_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_META_DATA_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_SOFT_STOP_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_PLAYER_JOINED_EVENT_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_PLAYER_LEFT_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_HOST_INFORMATION_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_HOST_INFORMATION_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_INFORMATION_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_INFORMATION_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_GET_STATUS_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_GET_STATUS_RESPONSE,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_SET_STATUS_REQUEST,
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_APPLICATION_INSTANCE_SET_STATUS_RESPONSE,
