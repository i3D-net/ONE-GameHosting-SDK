...
typedef enum OneError {
    ...
    ONE_ERROR_CODEC_DATA_LENGTH_TOO_SMALL,
    ONE_ERROR_CODEC_DATA_LENGTH_TOO_BIG,
    ONE_ERROR_CODEC_EXPECTED_DATA_LENGTH_TOO_BIG,
    ONE_ERROR_CODEC_DATA_LENGTH_NOT_MATCHING_EXPECTED_LENGTH,
    ...
    ONE_ERROR_MESSAGE_OPCODE_NOT_MATCHING_EXPECTING_ERROR_RESPONSE,
