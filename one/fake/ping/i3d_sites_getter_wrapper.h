...
/// I3dPingSitestWrapper encapsulates the integration for the i3D PingSites and
...
class I3dPingSitesWrapper final {
public:
    I3dPingSitesWrapper();
    I3dPingSitesWrapper(const I3dPingSitesWrapper &) = delete;
    I3dPingSitesWrapper &operator=(const I3dPingSitesWrapper &) = delete;
    ~I3dPingSitesWrapper();
